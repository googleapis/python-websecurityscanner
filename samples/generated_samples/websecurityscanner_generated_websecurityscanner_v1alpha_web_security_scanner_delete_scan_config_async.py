...
# [START websecurityscanner_generated_websecurityscanner_v1alpha_WebSecurityScanner_DeleteScanConfig_async]
...
async def sample_delete_scan_config():
    ...
    # Make the request
    response = await client.delete_scan_config(request=request)


# [END websecurityscanner_generated_websecurityscanner_v1alpha_WebSecurityScanner_DeleteScanConfig_async]
