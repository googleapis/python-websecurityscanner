...
from google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.base import (
...
def test_web_security_scanner_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_web_security_scanner_base_transport():
    ...
    with mock.patch(
        "google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerTransport.__init__"
    ) as Transport:
