...
# [START websecurityscanner_generated_websecurityscanner_v1alpha_WebSecurityScanner_DeleteScanConfig_sync]
...
def sample_delete_scan_config():
    ...
    # Make the request
    response = client.delete_scan_config(request=request)


# [END websecurityscanner_generated_websecurityscanner_v1alpha_WebSecurityScanner_DeleteScanConfig_sync]
