...
class WebSecurityScannerGrpcTransport(WebSecurityScannerTransport):
    ...
    def create_scan_config(
        ...
        [web_security_scanner.CreateScanConfigRequest], gcwv_scan_config.ScanConfig
    ]:
        ...
        if "create_scan_config" not in self._stubs:
            self._stubs["create_scan_config"] = self.grpc_channel.unary_unary(
                ...
                response_deserializer=gcwv_scan_config.ScanConfig.deserialize,
            )
    ...
    def update_scan_config(
        ...
        [web_security_scanner.UpdateScanConfigRequest], gcwv_scan_config.ScanConfig
    ]:
