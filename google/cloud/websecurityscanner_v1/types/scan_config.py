...
__protobuf__ = proto.module(
    package="google.cloud.websecurityscanner.v1beta", manifest={"ScanConfig",},
)
...
class ScanConfig(proto.Message):
    ...
    class Authentication(proto.Message):
        ...
        google_account = proto.Field(
            proto.MESSAGE, number=1, message="ScanConfig.Authentication.GoogleAccount",
        )
        custom_account = proto.Field(
            proto.MESSAGE, number=2, message="ScanConfig.Authentication.CustomAccount",
        )
