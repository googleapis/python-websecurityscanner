...
def test_create_scan_config(transport: str = 'grpc', request_type=web_security_scanner.CreateScanConfigRequest):
    ...
    with mock.patch.object(
            type(client._transport.create_scan_config),
            '__call__') as call:
...
async def test_create_scan_config_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.create_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_scan_config(transport: str = 'grpc', request_type=web_security_scanner.DeleteScanConfigRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_scan_config_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.delete_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_scan_config(transport: str = 'grpc', request_type=web_security_scanner.GetScanConfigRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_scan_config_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.get_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_scan_configs(transport: str = 'grpc', request_type=web_security_scanner.ListScanConfigsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_scan_configs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_scan_config(transport: str = 'grpc', request_type=web_security_scanner.UpdateScanConfigRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.update_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcw_scan_config.ScanConfig(
            name='name_value',
...
async def test_update_scan_config_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.update_scan_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcw_scan_config.ScanConfig(
            name='name_value',
...
def test_start_scan_run(transport: str = 'grpc', request_type=web_security_scanner.StartScanRunRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.start_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_start_scan_run_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.start_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_scan_run(transport: str = 'grpc', request_type=web_security_scanner.GetScanRunRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = scan_run.ScanRun(
            name='name_value',
...
async def test_get_scan_run_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.get_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(scan_run.ScanRun(
            name='name_value',
...
def test_list_scan_runs(transport: str = 'grpc', request_type=web_security_scanner.ListScanRunsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_scan_runs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_stop_scan_run(transport: str = 'grpc', request_type=web_security_scanner.StopScanRunRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.stop_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = scan_run.ScanRun(
            name='name_value',
...
async def test_stop_scan_run_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.stop_scan_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(scan_run.ScanRun(
            name='name_value',
...
def test_list_crawled_urls(transport: str = 'grpc', request_type=web_security_scanner.ListCrawledUrlsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_crawled_urls),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_finding(transport: str = 'grpc', request_type=web_security_scanner.GetFindingRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_finding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_finding_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.get_finding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_findings(transport: str = 'grpc', request_type=web_security_scanner.ListFindingsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_findings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_finding_type_stats(transport: str = 'grpc', request_type=web_security_scanner.ListFindingTypeStatsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_finding_type_stats),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_finding_type_stats_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.list_finding_type_stats),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_web_security_scanner_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
