...
class WebSecurityScannerClient(metaclass=WebSecurityScannerClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, WebSecurityScannerTransport] = None,
    ...
    def create_scan_config(
        ...
        *,
        parent: str = None,
        scan_config: gcwv_scan_config.ScanConfig = None,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            scan_config (:class:`~.gcwv_scan_config.ScanConfig`):
    ...
    def get_finding(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.get_finding, default_timeout=None, client_info=_client_info,
        )
