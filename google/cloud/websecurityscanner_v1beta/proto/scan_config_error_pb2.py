...
ScanConfigError = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      field_name:
          Indicates the full name of the ScanConfig field that triggers
          this error, for example "scan\_config.max\_qps". This field is
          provided for troubleshooting purposes only and its actual
