...
from google.cloud.websecurityscanner_v1.types import (
    finding_type_stats as gcwv_finding_type_stats,
)
...
class CreateScanConfigRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            'projects/{projectId}'.
        scan_config (~.gcwv_scan_config.ScanConfig):
            Required. The ScanConfig to be created.
    """

    parent = proto.Field(proto.STRING, number=1)
    scan_config = proto.Field(
        proto.MESSAGE, number=2, message=gcwv_scan_config.ScanConfig,
    )
...
class ListScanConfigsResponse(proto.Message):
    ...
    Attributes:
        scan_configs (Sequence[~.gcwv_scan_config.ScanConfig]):
    ...
    scan_configs = proto.RepeatedField(
        proto.MESSAGE, number=1, message=gcwv_scan_config.ScanConfig,
    )
...
class ListFindingTypeStatsResponse(proto.Message):
    ...
    Attributes:
        finding_type_stats (Sequence[~.gcwv_finding_type_stats.FindingTypeStats]):
            The list of FindingTypeStats returned.
    """

    finding_type_stats = proto.RepeatedField(
        proto.MESSAGE, number=1, message=gcwv_finding_type_stats.FindingTypeStats,
    )
